...
<div class="fixed bottom-4 right-4">
    <button class="p-3 rounded-full bg-indigo-600 text-white hover:bg-indigo-500" onclick="toggleChatPopup()">
        <svg fill="#FFFFFF" class="h-6 w-6" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
...
<div class="hidden customer-chat-popup fixed bottom-4 right-4 bg-gunmetal rounded-lg shadow-lg p-4">
    <div class="flex items-center justify-between">
        <div class="cursor-pointer toggle-customer-chat">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-white hover:text-gray-800" viewBox="0 0 20 20"
                fill="currentColor">
                <path fill-rule="evenodd"
                    d="M3.646 9.646a.5.5 0 0 1 .708 0L10 14.293l5.646-5.647a.5.5 0 1 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z" />
            </svg>
        </div>
    ...
    <form id="chat-form" method="POST">
        ...
        <div class="p-4">
            <div class="flex">
                <input type="text" name="message" class="w-full rounded-lg border p-2"
                    placeholder="Enter your message">
                <button class="ml-2 bg-indigo-600 text-white px-4 py-2 rounded-lg hover:bg-indigo-500"
